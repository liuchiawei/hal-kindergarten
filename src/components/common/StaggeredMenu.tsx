    ...
    if (itemEls.length) {
      ...
      tl.to(
        itemEls,
        {
          yPercent: 0,
          rotate: 0,
          duration: 0.1, // menu item animation duration
          ease: "power4.out",
          stagger: { each: 0.08, from: "start" }, // delay between each menu item
        },
        itemsStart
      );
  ...
  return (
    ...
    >
      ...
      >
        <div
          ref={preLayersRef}
          className="sm-prelayers w-full max-w-lg absolute top-0 right-0 bottom-0 pointer-events-none z-[5]"
          aria-hidden="true"
        >
          {(() => {
            const raw =
